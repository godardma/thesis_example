...
fig1.set_axes(IntervalVector([[3,5],[1,2]])) # set the x-axis index to 0 and its range to [-10,10], same for y with index 1
...
fig2.set_axes(IntervalVector([[1,9],[-1,2.3]])) # set the x-axis index to 0 and its range to [-10,10], same for y with index 1
